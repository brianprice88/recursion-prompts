...
var exponent = function(base, exp) {
    ...
    if (exp === -1) {return (1/base).toFixed(4)}
    if (exp > 1)
    {return base * exponent(base, exp-1)}
    if (exp < 1)
    {return (1/base).toFixed(4) * exponent(base, exp+1)}
};
...
var palindrome = function(string) {
    ...
    var lastCharacter = string.slice(string.length-1);
    if (firstCharacter.toUpperCase() === lastCharacter.toUpperCase()) {
